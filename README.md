...
* **Category Insights:** Across every product category gross margin is consistent (27.2% - 29.3%) with Patient Care being the higest margin and having the highest-volume category further indicating margin discipline even in high order volume.
* **Volume-Price Relationship:** Order volume and unit price have an inverse relationship. That being low-volume categories like Surgical Supplies listed at premium unit prices (~$448 average) then categories like Personal Protection Equipment and Patient Care are listed at lower unit prices (~$8–9 average) but making up majority of the total order quantity. 
## Data Visualization
